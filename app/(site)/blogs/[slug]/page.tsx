...
export async function generateMetadata({ params }: { params: Params }) {
  ...
  const url = `https://northwindyamuna.com/blogs/${slug}`;
...
export default async function BlogDetail({ params }: { params: Params }) {
  ...
  const pageUrl = `https://northwindyamuna.com/blogs/${slug}`;
  const imageUrl = typeof blog.image === "string" ? blog.image : "";
  ...
  const breadcrumbSchema = {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Blog",
        item: "https://northwindyamuna.com/blogs",
      },
      {
        "@type": "ListItem",
        position: 3,
  ...
  const articleSchema = {
    ...
    author: blog.author
      ...
      : { "@type": "Organization", name: "Northwind Yamuna" },
    publisher: {
      "@type": "Organization",
      name: "Real Revenue",
      logo: {
