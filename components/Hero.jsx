  ...
  const slides = [
    {
      ...
      title: "The Address",
      description: "Four G+30 towers on five acres, 600+ fully furnished homes, 15 minutes from Noida International Airport.",
    ...
    },
    {
      ...
      title: "Pool Deck",
      description: "Evening pool deck beside the residences, shared by only six homes per floor.",
    ...
    },
    {
      ...
      title: "Clubhouse",
      description: "A 50,000 sq. ft. wellness clubhouse with spa, sauna, steam and a fully equipped gym.",
